...
// The bot ready activity!
client.on("ready", () => {
  console.log(`The discord bot is ready to use! \n` + `\n © General Public License (GPL) 2021 Skypixel™`);
  client.user.setPresence({
    // status: "idle",  //You can show online, idle, dnd....
    // game: {
    //     name: "Creation Metro",  //The message shown
